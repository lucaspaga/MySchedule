...
public class AlterarTarefaTela extends JDialog implements ActionListener{
    ...
    public AlterarTarefaTela(JFrame fr, Tarefa tarefaAnt, ResourceBundle bn,  String user, int id){
        super(fr, "My Schedule");


        rdb.consultarId(tarefaAnt);
        ...
        btnAlterar = new JButton(bn.getString("tabela.alterartarefa"));
        ...
        btnAlterar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                    ...
                    if(tarefa.getDescricao().equals("x") || tarefa.getData().equals("x")){
                        ...
                        rdb.alterarReg(tarefa, tarefaAnt.getID());
        ...
        txtDescricao.setText(tarefaAnt.getDescricao());

        lblData = new JLabel(bn.getString("TelaNovaTarefa.data"));
        txtData = new JTextField(10);
        txtData.setText(tarefaAnt.getData());
